...
public:
    ...
    void                    RegisterNode(util::other::Uuid uuid, const NodeRegInfo& info);
    void                    NodeOffline(util::other::Uuid uuid);
    void                    NodeOffline(bbt::network::ConnId connid);
    NodeRegInfo*            GetNodeInfo(util::other::Uuid uuid);
    NodeRegInfo*            GetNodeInfo(bbt::network::ConnId connid);
    NodeState               GetNodeState(util::other::Uuid uuid) const;
private:
    void                    DebugPrint();
private:
    std::unordered_map<util::other::Uuid, NodeRegInfo, util::other::Uuid::Hash>
